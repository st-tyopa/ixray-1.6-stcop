...
using mask_inv_num_items = CSE_ALifeInventoryItem::mask_num_items;
...
protected:
	net_updateInvData* m_net_updateData = nullptr;
...
private:
	CPhysicsShellHolder* m_object = nullptr;
	Irect m_inv_rect;
...
public:
	...
	////////// upgrades //////////////////////////////////////////////////
public:
	using Upgrades_type = xr_vector<shared_str>;
