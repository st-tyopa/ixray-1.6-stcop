...
void CLevel::OnSecureMessage	(NET_Packet & P)
{
	...
	u32 checksum		= secure_messaging::decrypt(dec_packet.GetBuffer(), dec_packet.GetBufferSize(), m_secret_key);
	u32 real_checksum	= 0;
...
void CLevel::SecureSend	(NET_Packet& P, u32 dwFlags, u32 dwTimeout)
{
	...
	u32 checksum		= secure_messaging::encrypt(P.GetBuffer(), P.GetBufferSize(), m_secret_key);
